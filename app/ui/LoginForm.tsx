...
export default function LoginForm() {
  ...
  return (
    <form action={formAction} className="space-y-3">
      <div className="flex-1 rounded-lg bg-slate-200 dark:bg-slate-800 px-6 pb-4 pt-8">
        ...
        <div className="w-full">
          <div>
            <label
              className="mb-3 mt-5 block text-xs font-medium text-slate-500 dark:text-slate-400"
              htmlFor="email"
            >
              Email
            </label>
